...
const DashboardLuxury = () => {
  ...
  let googleCompanyName = 'luxuryGoogle';
  let metaCompanyName = 'luxuryMeta';
  let whatsappCompanyName = 'luxuryWhatsApp';
...
// Add a small hook to measure container width
