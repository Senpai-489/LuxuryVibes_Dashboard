...
const DashboardRooftop = () => {
  const [fetchedData, setFetchedData] = useState<any[] | null>(null);
  let googleCompanyName = 'rooftopGoogle';
  let metaCompanyName = 'rooftopMeta';
  let whatsappCompanyName = 'rooftopWhatsApp';
...
export default DashboardRooftop;